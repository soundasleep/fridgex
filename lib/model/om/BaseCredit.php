...
abstract class BaseCredit extends BaseObject  implements Persistent {
	...
	public function setQuantity($v)
	{
		...
		if ($this->quantity !== $v) {
			$this->quantity = $v;
			$this->modifiedColumns[] = CreditPeer::QUANTITY;
		}
	...
	public function setPrice($v)
	{
		...
		if ($this->price !== $v) {
			$this->price = $v;
			$this->modifiedColumns[] = CreditPeer::PRICE;
		}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CreditPeer::QUANTITY)) $criteria->add(CreditPeer::QUANTITY, $this->quantity);
		if ($this->isColumnModified(CreditPeer::PRICE)) $criteria->add(CreditPeer::PRICE, $this->price);
